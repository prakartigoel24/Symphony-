  ...
  <div className="mt-10">
    {links.map((item) => (
      <NavLink
        key={item.name}
        to={item.to}
        className="flex flex-row justify-start items-center my-8 text-sm md:text-md lg:text-lg font-medium text-gray-200 hover:text-cyan-400"
...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="md:flex hidden flex-col w-[220px] py-10 px-4 bg-[#191624] h-screen">
        <img src="/logo1.jpg" alt="logo" className="w-full h-14 lg:h-20 object-contain" />
        <NavLinks />
      </div>
